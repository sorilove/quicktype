...
jq --arg version $VERSION \
    '.dependencies."sorilove-quicktype-core" = $version' \
...
# pubish quicktype
jq --arg version $VERSION \
    '.dependencies."sorilove-quicktype-core" = $version | .dependencies."sorilove-quicktype-graphql-input" = $version | .dependencies."sorilove-quicktype-typescript-input" = $version' \
    package.json > package.1.json
mv package.1.json package.json
npm publish
